if(NOT BUILD_OS_WINDOWS)
    ...
    if( BUILD_OS_WIN32 )
        add_custom_target(NumPy
            COMMAND ${PYTHON_EXECUTABLE} -m pip install https://s3.us-east-2.amazonaws.com/robo-cura-staging/resources/numpy-1.14.5%2Bmkl-cp35-cp35m-win32.whl
            COMMENT "Installing NumPy"
        )
    else()
        add_custom_target(NumPy
            COMMAND ${PYTHON_EXECUTABLE} -m pip install https://s3.us-east-2.amazonaws.com/robo-cura-staging/resources/numpy-1.14.5%2Bmkl-cp35-cp35m-win_amd64.whl
            COMMENT "Installing NumPy"
        )
    endif()
endif()
