if(NOT BUILD_OS_WINDOWS)
    ...
    if( BUILD_OS_WIN32 )
        add_custom_target(SciPy
            COMMAND ${PYTHON_EXECUTABLE} -m pip install https://s3.us-east-2.amazonaws.com/robo-cura-staging/resources/scipy-1.0.1-cp35-none-win32.whl
            COMMENT "Installing SciPy"
        )
    SetProjectDependencies(TARGET PyQt DEPENDS Python)
    else()
        add_custom_target(SciPy
            COMMAND ${PYTHON_EXECUTABLE} -m pip install https://s3.us-east-2.amazonaws.com/robo-cura-staging/resources/scipy-1.0.1-cp35-none-win_amd64.whl
            COMMENT "Installing SciPy"
        )
    endif()
endif()
